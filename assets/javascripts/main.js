...
(function() {
  ...
  var _isLoaded, activeTimeEntryId, app_config, autocompleteBlur, autocompleteClick, autocompleteFocus, autocompleteSelect, autocompleteSourceDefault, autocompleteSourceRecent, cache, cacheTimeEntries, cancelEdit, confirmDelete, confirmDialog, createTimeEntriesUrl, createTimeEntry, dateIsWeekend, dateYmdEqual, datepickerChangeDays, datepickerUpdate, debug, decrementDate, deleteTimeEntry, displayFormDataToDom, displayTimeEntries, exitEditMode, extendBase, fieldNameToDisplayName, fieldNameToSelector, formDataToAPIData, getDisplayFormData, getFormData, getIssuesProjectsAndSearchData, getSearchFormData, getTimeEntries, hasReceiveFormat, helper, hideNextDateButton, incrementDate, initAutoDataReload, initAutocomplete, initDeleteDialog, initialise, insertTimeEntryAsNew, insertTimeEntryRows, loading, missingFieldsError, onTimeEntriesReload, openInRedmineUpdateURL, prevTimeEntry, redmine, reloadSearchData, resetForm, resetFormAfterSync, resetFormButton, setDate, startEditMode, sync, timeEntriesLoadingDelayed, timeEntryReceiveToSendFormat, timeEntryToDOM, timeEntryToSearchDataEntry, timeEntryToTableRow, timeFormat, translate, updateTimeEntry, validate, validateFieldExistence, validateOther;
