...
(function() {
  ...
  sortByLocaleIgnoreTicketId = function(a) {
    return a.sort(function(a, b) {
      return a.value.replace(ignoreTicketIdRegexp, "").localeCompare(b.value.replace(ignoreTicketIdRegexp, ""));
    });
  };
