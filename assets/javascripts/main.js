  ...
  validateOther = function(formData) {
    ...
    if (redmineData.overbooking_warning) {
      ...
      if ((!(old_hours === new_hours)) && (estimated > total_spent) && (estimated < new_hours + total_spent)) {
        return confirm(translate("overbooking_warning"), translate("warning"));
      }
    }
    return true;
  };
...
// Generated by CoffeeScript 2.3.2
(function() {
  var config, createTimeEntry, defaultRedmineErrorHandler, deleteTimeEntry, getProjectsAndIssues, getRecent, getSpentTime, getTimeEntries, redmineConfig, updateTimeEntry, urls;
