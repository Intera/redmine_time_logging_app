...
(function() {
  ...
  var _isLoaded, activeTimeEntryId, app_config, autocompleteBlur, autocompleteClick, autocompleteFocus, autocompleteSelect, autocompleteSourceDefault, autocompleteSourceRecent, base_init, cache, cacheTimeEntries, cancelEdit, confirmDelete, confirmDialog, createTimeEntriesUrl, dateIsWeekend, datepickerChangeDays, datepickerUpdate, debug, decrementDate, deleteTimeEntry, displayFormDataToDom, displayTimeEntries, editing_init, exitEditMode, extendBase, fieldNameToDisplayName, fieldNameToSelector, formDataToAPIData, getActivities, getCurrentUser, getDisplayFormData, getFormData, getIssuesProjectsAndSearchData, getSearchFormData, getTimeEntries, hasReceiveFormat, helper, incrementDate, init, initAutoDataReload, initAutocomplete, initDatepicker, initDeleteDialog, insertTimeEntryAsNew, insertTimeEntryRows, loading, missingFieldsError, onSubmit, onTimeEntriesReload, openInRedmineUpdateURL, prevTimeEntry, redmine, reloadSearchData, resetForm, resetFormAfterSync, resetFormButton, setDate, startEditMode, sync, timeEntriesLoadingDelayed, timeEntryReceiveToSendFormat, timeEntryToDOM, timeEntryToSearchDataEntry, timeEntryToTableRow, timeFormat, translate, translations, updateTimeEntry, validate, validateFieldExistence, validateOther;
  ...
  base_init = function() {
    ...
    r = $.when(redmine.init(), getCurrentUser().done(helper.wrapDeferred(initDatepicker)), getActivities(), getIssuesProjectsAndSearchData(app_config.issueStatus)).done(function() {
      ...
      loading(false);
      initAutoDataReload();
      return helper.$$("#search").trigger("focus", {
        onlyFocus: true
      }).select();
    });
    $("button").button();
