...
(function() {
  ...
  missingFieldsError = function(missingFields) {
    return _.map(missingFields, function(a) {
      if (_.isArray(a)) {
        return missingFieldsError(a).join(" " + translate("or") + " ");
      } else {
  ...
  setTranslation = function() {
    ...
    return $(".hours-header").html(translate("hours_header"));
  };
