...
// Generated by CoffeeScript 2.3.2
(function() {
  var $$, autocompleteMatchFunc, config, copyDateObject, createIssueSearchDataEntry, createProjectSearchDataEntry, createProjectsIssuesAndSearchData, decimalHoursToColonFormat, decimalHoursToHoursAndMinutes, defaultDialogConfig, delim, displayDialog, entityMap, escapeHtml, getBrowserLanguage, ignoreTicketIdRegexp, issueIdToUrl, mobileHideAddressBar, onKeypressRejectNaN, padZeros, projectNameToId, removeErrorClass, selectAll, setCursorPosition, setSelectionRange, sortByLocaleIgnoreTicketId, stringContains, stringContainsEvery, timeLimitedFunc, wrapDeferred;
