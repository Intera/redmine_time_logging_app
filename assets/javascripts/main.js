...
(function() {
  ...
  var _isLoaded, activeTimeEntryId, app_config, autocompleteBlur, autocompleteClick, autocompleteFocus, autocompleteSelect, autocompleteSourceDefault, autocompleteSourceRecent, cache, cacheTimeEntries, cancelEdit, confirmDelete, confirmDialog, createTimeEntriesUrl, createTimeEntry, dateIsWeekend, datepickerChangeDays, datepickerUpdate, debug, decrementDate, deleteTimeEntry, displayFormDataToDom, displayTimeEntries, exitEditMode, extendBase, fieldNameToDisplayName, fieldNameToSelector, formDataToAPIData, getDisplayFormData, getFormData, getIssuesProjectsAndSearchData, getSearchFormData, getTimeEntries, hasReceiveFormat, helper, incrementDate, initAutoDataReload, initAutocomplete, initDeleteDialog, initialise, insertTimeEntryAsNew, insertTimeEntryRows, loading, missingFieldsError, onTimeEntriesReload, openInRedmineUpdateURL, prevTimeEntry, redmine, reloadSearchData, resetForm, resetFormAfterSync, resetFormButton, setDate, startEditMode, sync, timeEntriesLoadingDelayed, timeEntryReceiveToSendFormat, timeEntryToDOM, timeEntryToSearchDataEntry, timeEntryToTableRow, timeFormat, translate, translations, updateTimeEntry, validate, validateFieldExistence, validateOther;
  ...
  initialise = function() {
    ...
    window.displayLanguage = translations[lang] ? lang : "en";
...
// Generated by CoffeeScript 2.3.2
(function() {
  var config, createTimeEntry, defaultRedmineErrorHandler, deleteTimeEntry, getActivities, getCurrentUser, getIssues, getProjects, getProjectsAndIssues, getRecentTimeEntryObjects, getTimeEntries, redmineConfig, updateTimeEntry, urls;
