...
// Generated by CoffeeScript 2.5.1
(function() {
  var $$, autocompleteMatchFunc, config, copyDateObject, createIssueSearchDataEntry, createProjectSearchDataEntry, createProjectsIssuesAndSearchData, decimalHoursToColonFormat, decimalHoursToHoursAndMinutes, defaultDialogConfig, delim, displayDialog, entityMap, escapeHtml, falseIfNaN, getBrowserLanguage, issueIdToUrl, mobileHideAddressBar, onKeypressRejectNaN, padZeros, projectNameToId, removeErrorClass, roundFloat, selectAll, setCursorPosition, setSelectionRange, stringContains, stringContainsEvery, timeLimitedFunc, wrapDeferred;
...
(function() {
  ...
  openInRedmineUpdateURL = function(data) {
    ...
    if (data) {
      ...
      return helper.$$("button.open-in-redmine").data("href", url).show();
    } else {
      return helper.$$("button.open-in-redmine").hide();
    }
  };
  ...
  initAutoDataReload = function() {
    var intervalAutoReload, timer;
    if (!app_config.autoReloadInterval) {
      return;
    }
    intervalAutoReload = function(interval) {
      var timer;
      if (timer) {
        clearInterval(timer);
      }
    ...
    timer = void 0;
    return intervalAutoReload(app_config.autoReloadInterval);
  };
